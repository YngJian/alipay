package cn.sunline.tiny.alipay;
...
public class AliPayApiConfig implements Serializable {
    ...
    public String getPrivateKey() {
        if (StrUtil.isBlank(privateKey)) {
            throw new IllegalStateException("privateKey is not assigned");
        }
        return privateKey;
    }
    ...
    public AliPayApiConfig setPrivateKey(String privateKey) {
        if (StrUtil.isEmpty(privateKey)) {
            throw new IllegalArgumentException("privateKey value cannot be null");
        }
    ...
    public String getAppId() {
        if (StrUtil.isEmpty(appId)) {
            throw new IllegalStateException("appId is not assigned");
        }
        return appId;
    }
    ...
    public AliPayApiConfig setAppId(String appId) {
        if (StrUtil.isEmpty(appId)) {
            throw new IllegalArgumentException("appId value cannot be null");
        }
        this.appId = appId;
        return this;
    }
    ...
    public String getServiceUrl() {
        if (StrUtil.isEmpty(serviceUrl)) {
            throw new IllegalStateException("serviceUrl is not assigned");
        }
        return serviceUrl;
    }
    ...
    public AlipayClient getAliPayClient() {
        if (alipayClient == null) {
            throw new IllegalStateException("aliPayClient is not initialized");
        }
        return alipayClient;
    }
