...
public class AliPayApiConfigKit {
    ...
    public static AliPayApiConfig getApiConfig(String appId) {
        ...
        if (cfg == null) {
            throw new IllegalStateException("You need to call AliPayApiConfigKit.putApiConfig(aliPayApiConfig) to store " +
                    "the aliPayApiConfig object corresponding to appId before you can use the series methods of AliPayApiConfigKit.getAliPayApiConfig()");
        }
        return cfg;
    }
}