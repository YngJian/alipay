...
public class ReturnFlow extends JavaFlow {
    ...
    @Get
    @FlowCom(in = "true", name = "view", desc = "return url")
    public Result flow_1(Context ct, PriCache pri, PubCache pub) {
        log.info("+++++++++++++++++return flow: Callback started+++++++++++++++++");
        ...
        try {
            ...
            if (verifyResult) {
                ...
                log.info("++++++++++++++Return_Url verification success+++++++++++++++");
                return errorCenter.getResultByEasyCodeAndLanguage(errors, "SUCCESS", pri);
            } else {
                log.info("+++++++++++++++Return_Url verification failed+++++++++++++++");
                // TODO
